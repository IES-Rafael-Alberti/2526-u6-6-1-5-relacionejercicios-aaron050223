...
### a) ¿Por qué es importante comentar/documentar? ¿Cual es la diferencia entre comentarios y documentación?
...
**¿Cual es la diferencia entre comentarios y documentación?**
...
- La documentación es más un manual. Suele explicar el como se usa algo en concreto.
